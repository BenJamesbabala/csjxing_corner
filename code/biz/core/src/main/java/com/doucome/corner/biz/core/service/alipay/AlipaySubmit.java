...
public class AlipaySubmit {
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        ...
        sPara.put("sign_type", EnvPropertiesUtil.getProperty(EnvConstant.CORNER_ALIPAY_SIGNTYPE));
    ...
    public static String buildForm(Map<String, String> sParaTemp, String gateway, String strMethod,
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + gateway
                      + "_input_charset=" + EnvPropertiesUtil.getProperty(EnvConstant.CORNER_ALIPAY_CHARSET) + "\" method=\"" + strMethod
                      + "\">");
