...
public class ItemSearchAction extends DdzBasicAction implements ModelDriven<TaobaokeItemFacade> {
    ...
    public String execute() throws Exception {
        if (StringUtils.isNotBlank(id)) {
            ...
            } else if (!StringUtils.equals(alipayId, ddzAuthz.getAlipayId())) {
            ...
            //转换商品
            TaobaokeItemDTO internalItem = taobaokeServiceDecorator.conventItem(id, outCode , TaobaokeFields.taoke_item_fields );
